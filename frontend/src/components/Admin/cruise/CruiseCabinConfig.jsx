    ...
    const handleModalSubmit = async () => {
        ...
        try {
            if (editingTempId) {
                ...
                // --- CASE C: CREATE NEW TEMPLATE (Via API) ---
                const success = await onTemplateCreateRequest(newCabinForm);
                if (success) {
                    toast.success("New cabin template created!");
                    setIsModalOpen(false);
                    onTemplateCreated(); // Refresh Library
                }
            }
            ...
            >
                ...
                <div className="mb-6">
                    ...
                    <Table
                        ...
                        locale={{ emptyText: <div className="py-4 text-gray-400">No cabins selected yet. Choose from the library below.</div> }}
                        columns={[
