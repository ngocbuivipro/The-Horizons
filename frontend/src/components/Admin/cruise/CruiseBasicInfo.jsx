        ...
        <Card title={<><FaShip className="inline mr-2"/> Cruise Information</>} className="shadow-sm rounded-2xl">
            <Row gutter={[24, 24]}>
                ...
                <Col span={12} md={6}>
                    ...
                    <Select value={data.cruiseType} onChange={v => handleChange('cruiseType', v)} options={["Luxury cruise", "Adventure cruise"].map(t => ({ label: t, value: t }))} className="w-full" size="large" />
                </Col>
                <Col span={12} md={6}>
                ...
                <Col span={12} md={6}>
                    ...
                    <DatePicker showTime picker="time" format="HH:mm" value={data.departureTime} onChange={v => handleChange('departureTime', v)} className="w-full" size="large" />
                </Col>
                <Col span={12} md={6}>
