import { Select, TimePicker, Switch, Rate } from "antd";
            ...
            <div className="bg-white border border-gray-100 shadow-sm rounded-2xl p-6 md:p-8">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex gap-3 w-full md:max-w-md">
                  ...
                  />
                  <button type="button" onClick={() => { if (inputRoomType.trim()) { setRoomTypeDefault([...roomTypeDefault, inputRoomType]); setInputRoomType(""); } }} className="px-4 py-3 bg-gray-800 text-white rounded-xl">Add Type</button>
                </div>
