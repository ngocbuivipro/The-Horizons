        ...
        <div className="w-full min-h-screen font-sans text-gray-800 relative">
            <div className="max-w-[1400px] mx-auto px-4 md:px-8">
                ...
                <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-3 mt-8 mb-10 border border-gray-100 hidden lg:flex items-center gap-2">
                    ...
                    {/* Fixed: Attached handleMainSearch to trigger the search explicitly */}
                    <button
                        onClick={handleMainSearch}
                        className="bg-red-500 hover:bg-red-600 text-white font-bold h-12 w-28 rounded-xl transition-colors shadow-lg shadow-red-200"
                    >
                        Search
                    </button>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start relative">
                    <aside className="hidden lg:block lg:col-span-1 sticky top-24">
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <button onClick={handleClearFilters} className="text-xs text-red-500 font-bold uppercase hover:underline">Reset</button>
                        </div>
                        <FilterContent
