                                        ...
                                        <div>
                                            ...
                                            {startDate && (
                                                <div className="text-xs text-gray-500 mt-1 flex justify-between">
                                                    <span>Duration: {cruise.duration} Days</span>
                                        ...
                                        <div className="flex gap-1 flex-wrap mt-2">
                                            {availableCurrencies.map(cur => (
                                                <button
                                                    ...
                                                    className={`px-2 py-1 rounded text-[10px] font-bold border ${selectedCurrency === cur ? 'bg-red-500 text-white border-red-500' : 'bg-white text-gray-500 border-gray-200'}`}
                                                >
                                                    {cur}
                                                </button>
                                            ))}
                                        ...
                                        {startDate && priceBreakdown && guests > 0 && selectedCabinId && (
                                            <div className="bg-gray-50 p-3 rounded-lg text-sm space-y-2 mt-2">
                                                <div className="flex justify-between items-center text-xs text-gray-500">
                                                    <span>Price per night (x {priceBreakdown.nights} nights)</span>
                                ...
                                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                                    ...
                                    <div className="space-y-3 text-sm">
                                        <div className="flex justify-between border-b border-dashed border-gray-200 pb-2">
                                            ...
                                            <span className="font-semibold text-gray-800">{cruise.duration} Days</span>
                                        </div>
                                        <div className="flex justify-between border-b border-dashed border-gray-200 pb-2">
