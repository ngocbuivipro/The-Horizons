                    ...
                    <div className="border border-gray-200 rounded-2xl p-6 shadow-md bg-white">
                        ...
                        <div className="flex flex-col items-start gap-1 mb-6">
                            ...
                            <div className="flex items-center gap-1 text-sm font-medium text-gray-800">
                                <StarFilled className="text-rose-500"/>
                        ...
                        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden mb-4">
                            ...
                            <div className="flex border-gray-200">
                                ...
                                <div className="w-1/2 px-4 py-3 hover:bg-gray-50 transition-colors">
                                    <label
                                        className="block text-[10px] font-extrabold text-gray-500 uppercase">Children</label>
                                    <input
                                        type="number"
                                        min={0}
                                        value={children}
                        ...
                        <button
                            ...
                            className="w-full py-3.5 rounded-lg text-white font-bold text-lg transition-all duration-200 bg-[#DE3151] hover:bg-[#C11136] shadow-md hover:shadow-lg active:scale-[0.98] mb-3"
                        >
                            Reserve
                        </button>
