                    ...
                    <div className="w-full max-w-md space-y-6">
                        ...
                        {step === 0 ? (
                            ...
                            <Form form={registerForm} onFinish={handleRegister} layout="vertical" size="large" requiredMark={false}>
                                ...
                                >
                                    <Input prefix={<UserOutlined className="text-gray-400 mr-2" />} placeholder="John Doe" />
                                </Form.Item>
                                ...
                                >
                                    <Input.Password prefix={<LockOutlined className="text-gray-400 mr-2" />} placeholder="At least 6 characters" />
                                </Form.Item>
